...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      tags: ["React", "Tailwind CSS", "Framer Motion"],
      imageUrl:
        "https://images.unsplash.com/photo-1517180102446-f3ece451e9d8?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=80",
      demoUrl: "https://anandkishoreportfolio.vercel.app/",
      codeUrl: "https://github.com/anandkishore06?tab=repositories",
    },
    {
      title: "Weather Application",
      description:
    ...
    },
    {
      title: "Winsome App",
      description:
        "From idea to app - generate full-stack projects with a single prompt.",
      tags: [
        "TypeScipt",
        "Supabase",
        "Clerk",
