...
//           <Button
//             className="bg-teal text-dark hover:bg-teal/80 text-xs sm:text-sm flex-1 min-w-[120px]"
//             asChild
//           >
//             <a href={demoUrl} target="_blank" rel="noopener noreferrer">
//               Live Demo
...
//           <Button
//             variant="outline"
//             className="border-gray-dark hover:bg-gray-dark/30 text-xs sm:text-sm flex-1 min-w-[120px]"
//             asChild
//           >
//             <a href={codeUrl} target="_blank" rel="noopener noreferrer">
//               View Code
