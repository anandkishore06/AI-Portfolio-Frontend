      ...
      <div className="container-custom">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <div className="font-bold text-2xl gradient-text mb-3">Portfolio.</div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-dark text-center">
          <a href="#home" className="text-gray-400 hover:text-teal inline-flex items-center transition-colors duration-200">
